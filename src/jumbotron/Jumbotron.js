...
import cvPdf from "../assets/OMAR_BOUDRAA_CDA_CV.pdf";
        ...
        return (
            <div className="jumbotron jumbotron-fluid">
                <div className="container containerJumbo">
                    <h1>Développeur web et web mobile junior,<br/>Concepteur dévelopeur d'applications (...formation en cours) ;</h1>
                    <div className="row header">
                        ...
                        <div className="mesInfo col-7">
                            ...
                            <a className="lienCv" href={cvPdf} download={cvPdf}><FaIcons.FaFileDownload className="iconCv"/> CV en PDF</a>
                        </div>
